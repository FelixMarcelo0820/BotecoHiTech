...
namespace BotecoHitech.DataSetProdTableAdapters {
    ...
    public partial class ProdutoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Produto] WHERE (([ID] = @Original_ID) AND ([nome] = @Original_nome) " +
                "AND ([valor] = @Original_valor) AND ([Descricao] = @Original_Descricao) AND ([Qu" +
                "antidade] = @Original_Quantidade) AND ([Categoria] = @Original_Categoria))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Produto] ([nome], [valor], [Descricao], [Quantidade], [Categoria]) V" +
                "ALUES (@nome, @valor, @Descricao, @Quantidade, @Categoria);\r\nSELECT ID, nome, va" +
                "lor, Descricao, Quantidade, Categoria FROM Produto WHERE (ID = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Produto] SET [nome] = @nome, [valor] = @valor, [Descricao] = @Descricao, [Quantidade] = @Quantidade, [Categoria] = @Categoria WHERE (([ID] = @Original_ID) AND ([nome] = @Original_nome) AND ([valor] = @Original_valor) AND ([Descricao] = @Original_Descricao) AND ([Quantidade] = @Original_Quantidade) AND ([Categoria] = @Original_Categoria));
SELECT ID, nome, valor, Descricao, Quantidade, Categoria FROM Produto WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, nome, valor, Descricao, Quantidade, Categoria\r\nFROM            " +
                "Produto";
        ...
        public virtual int Fill(DataSetProd.ProdutoDataTable dataTable) {
        ...
        public virtual DataSetProd.ProdutoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetProd.ProdutoDataTable dataTable = new DataSetProd.ProdutoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetProd.ProdutoDataTable dataTable) {
