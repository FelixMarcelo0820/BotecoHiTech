...
namespace BotecoHitech.DataSetFornecedorTableAdapters {
    ...
    public partial class FornecedorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Fornecedor] WHERE (([nome] = @Original_nome) AND ([CNPJ] = @Original" +
                "_CNPJ) AND ([Endereco] = @Original_Endereco) AND ([Tipo] = @Original_Tipo) AND (" +
                "[Telefone] = @Original_Telefone) AND ([ID] = @Original_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Fornecedor] ([nome], [CNPJ], [Endereco], [Tipo], [Telefone]) VALUES " +
                "(@nome, @CNPJ, @Endereco, @Tipo, @Telefone);\r\nSELECT nome, CNPJ, Endereco, Tipo," +
                " Telefone, ID FROM Fornecedor WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Fornecedor] SET [nome] = @nome, [CNPJ] = @CNPJ, [Endereco] = @Endereco, [Tipo] = @Tipo, [Telefone] = @Telefone WHERE (([nome] = @Original_nome) AND ([CNPJ] = @Original_CNPJ) AND ([Endereco] = @Original_Endereco) AND ([Tipo] = @Original_Tipo) AND ([Telefone] = @Original_Telefone) AND ([ID] = @Original_ID));
SELECT nome, CNPJ, Endereco, Tipo, Telefone, ID FROM Fornecedor WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT nome, CNPJ, Endereco, Tipo, Telefone, ID FROM Fornecedor";
        ...
        public virtual int Delete(string Original_nome, string Original_CNPJ, string Original_Endereco, string Original_Tipo, string Original_Telefone, int Original_ID) {
        ...
        public virtual int Update(string nome, string CNPJ, string Endereco, string Tipo, string Telefone, string Original_nome, string Original_CNPJ, string Original_Endereco, string Original_Tipo, string Original_Telefone, int Original_ID, int ID) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string CNPJ, string Endereco, string Tipo, string Telefone, string Original_nome, string Original_CNPJ, string Original_Endereco, string Original_Tipo, string Original_Telefone, int Original_ID) {
            return this.Update(nome, CNPJ, Endereco, Tipo, Telefone, Original_nome, Original_CNPJ, Original_Endereco, Original_Tipo, Original_Telefone, Original_ID, Original_ID);
        }
    }
