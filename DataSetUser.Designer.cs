...
namespace BotecoHitech.DataSetUserTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Usuarios] WHERE (([ID] = @Original_ID) AND ([nome] = @Original_nome) AND ([usuario] = @Original_usuario) AND ([senha] = @Original_senha) AND ([endereco] = @Original_endereco) AND ([email] = @Original_email) AND ([telefone] = @Original_telefone) AND ([cpf] = @Original_cpf))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Usuarios] ([nome], [usuario], [senha], [endereco], [email], [telefone], [cpf]) VALUES (@nome, @usuario, @senha, @endereco, @email, @telefone, @cpf);
...
SELECT ID, nome, usuario, senha, endereco, email, telefone, cpf FROM Usuarios WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, nome, usuario, senha, endereco, email, telefone, cpf\r\nFROM     " +
                "       Usuarios";
        ...
        public virtual int Fill(DataSetUser.UsuariosDataTable dataTable) {
        ...
        public virtual DataSetUser.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetUser.UsuariosDataTable dataTable = new DataSetUser.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetUser.UsuariosDataTable dataTable) {
